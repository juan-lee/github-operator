...
// +kubebuilder:rbac:groups=github.juan-lee.dev,resources=runnerpools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=github.juan-lee.dev,resources=runnerpools/status,verbs=get;update;patch
